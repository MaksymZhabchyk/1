...
class DochClass(Osnova):
    def __init__(self, name=None, last_name=None, birth_year=None,
                 father_name=None, city=None, phone_number=None,
                 email=None, adress=None, hobbi=None):
...
person = DochClass("Максим", "Жабчик", 2008,
                   "Вадим", "Луцьк", "+380553394994",
                   "lutskhour@ukr.net", "Даня 18", "борьба")
